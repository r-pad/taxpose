...
# put_money_in_safe
taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/put_money_in_safe/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=10 wandb.group=rlbench_put_money_in_safe headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512
...
# take_money_out_safe
taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/take_money_out_safe/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=10 wandb.group=rlbench_take_money_out_safe headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512
