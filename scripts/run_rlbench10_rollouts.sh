...
# push_button
taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/push_button/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=5 wandb.group=rlbench_push_button headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512

# reach_target
# taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/reach_target/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=5 wandb.group=rlbench_reach_target headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512

# slide_block_to_target
# taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/slide_block_to_target/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=5 wandb.group=rlbench_slide_block_to_target headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512

# stack_wine
# taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/stack_wine/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=5 wandb.group=rlbench_stack_wine headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512
...
taskset -c 0-50 python scripts/eval_rlbench.py --config-name commands/rlbench/take_umbrella_out_of_umbrella_stand/taxpose_all/eval_rlbench.yaml num_trials=$NUM_TRIALS resources.num_workers=5 wandb.group=rlbench_take_umbrella_out_of_umbrella_stand headless=True task.action_mode=gripper_and_object task.anchor_mode=background_robot_removed model.num_points=512
